				...
				<div class="inner">
					...
					<section>
							<article class="box post post-excerpt">
								<header>
									<h2><a href="#"><?php echo $_SESSION['stitle'][$bookIndex];?></a></h2>
									
									<p><?php echo $_SESSION['sauthor'][$bookIndex];?> | <?php echo $_SESSION['spubdate'][$bookIndex];?></p>
								</header>
								<!--
								<div class="info">
									<!--
								...
								-->
								<h3>
									<b>ISBN: </b><?php echo $_SESSION['sisbn'][$bookIndex];?>
								</h3>
								<div class="box">
								<a href="#" class="image centered"><img src="<?php echo "images/" . $_SESSION['scover'][$bookIndex]?>"  alt="" /></a>
								</div>
								<p>
									<?php echo $_SESSION['sabstract'][$bookIndex];?>
								</p>
								<p>
									<b>Series: </b><?php echo $_SESSION['sseries'][$bookIndex];?>
								</p>
								<p>
									<b>Publishing House: </b><?php echo $_SESSION['spubhouse'][$bookIndex];?>
								</p>
								<p>
									<b>Publishing Date: </b><?php echo $_SESSION['pubdate'][$bookIndex];?>
								</p>
								<p>
									<b>Country: </b><?php echo $_SESSION['scountry'][$bookIndex];?>
								</p>
								<p>
									<b>Date Posted: </b><?php echo $_SESSION['sdate'][$bookIndex];?>
								</p>
